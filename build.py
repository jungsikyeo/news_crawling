...
def build_exe():
    ...
    cmd = [
        ...
        # 보고서 기능 (Claude Agent SDK)
        "--hidden-import", "api.report",
        "--hidden-import", "report.generator",
        "--hidden-import", "report.ai_summarizer",
        "--hidden-import", "report.article_scraper",
        "--hidden-import", "report.hwp_writer",
